...
Samples are a critical tool for learning the Office Scripts API. We welcome samples scripts from the community to help demonstrate useful scripting scenarios.
